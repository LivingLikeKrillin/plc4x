...
public class CIPEncapsulationReadRequest extends CIPEncapsulationPacket implements Message {
  ...
  public CIPEncapsulationReadRequest(Long sessionHandle, Long status, List<Short> senderContext,
      Long options, DF1RequestMessage request) {
  ...
  public static class CIPEncapsulationPacketBuilderImpl implements CIPEncapsulationPacket.CIPEncapsulationPacketBuilder {
    ...
    public CIPEncapsulationPacketBuilderImpl(DF1RequestMessage request) {
      this.request = request;
    }
