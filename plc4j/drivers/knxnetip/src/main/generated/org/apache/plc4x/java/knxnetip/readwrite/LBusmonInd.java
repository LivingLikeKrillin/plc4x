...
public class LBusmonInd extends CEMI implements Message {
  ...
  public LBusmonInd(Short additionalInformationLength,
      List<CEMIAdditionalInformation> additionalInformation, LDataFrame dataFrame, Short crc) {
  ...
  public static CEMIBuilder staticParseCEMIBuilder(ReadBuffer readBuffer, int size) throws
      BufferException {
    readBuffer.pushContext(WithOption.WithName("LBusmonInd"));
    ...
    return new CEMIBuilderImpl(additionalInformationLength, additionalInformation, dataFrame, crc);
  }

  protected void serializeCEMIChild(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("LBusmonInd"));
    ...
    if(crc != null) {
      // Optional Field: crc
      FieldWriterFactory.writeOptionalField((Short) crc, DataWriterFactory.writeUnsignedShort(writeBuffer, 8), WithOption.WithName("crc"));
    }
