...
public class LDataReq extends CEMI implements Message {
  ...
  public LDataReq(Short additionalInformationLength,
  ...
  public static CEMIBuilder staticParseCEMIBuilder(ReadBuffer readBuffer, int size) throws
      BufferException {
    readBuffer.pushContext(WithOption.WithName("LDataReq"));
  ...
  protected void serializeCEMIChild(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("LDataReq"));
