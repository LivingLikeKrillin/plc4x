...
public class ConnectionRequestInformationDeviceManagement extends ConnectionRequestInformation implements Message {
  ...
  public static ConnectionRequestInformationBuilder staticParseConnectionRequestInformationBuilder(
    ...
    readBuffer.pushContext(WithOption.WithName("ConnectionRequestInformationDeviceManagement"));
    int startPos = readBuffer.getPositionInBits();
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
    readBuffer.popContext();
    return new ConnectionRequestInformationBuilderImpl();
  }

  protected void serializeConnectionRequestInformationChild(WriteBuffer writeBuffer) throws
      BufferException {
    writeBuffer.pushContext(WithOption.WithName("ConnectionRequestInformationDeviceManagement"));
  ...
  public static class ConnectionRequestInformationBuilderImpl implements ConnectionRequestInformation.ConnectionRequestInformationBuilder {
    public ConnectionRequestInformationBuilderImpl() {
    }
