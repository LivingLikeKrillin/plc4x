...
public enum ComObjectValueType {
  ...
  public static ComObjectValueType firstEnumForFieldSizeInBytes(short sizeInBytes) {
  ...
  public static List<ComObjectValueType> enumsForFieldSizeInBytes(short sizeInBytes) {
