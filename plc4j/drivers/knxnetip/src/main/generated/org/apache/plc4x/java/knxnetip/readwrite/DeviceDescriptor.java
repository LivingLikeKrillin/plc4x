...
public enum DeviceDescriptor {
  ...
  PL110_MEDIA_COUPLER_PL_TP((int) 0x1900, FirmwareType.MEDIA_COUPLER_PL_TP, DeviceDescriptorMediumType.PL110),

  RF_BI_DIRECTIONAL_DEVICES((int) 0x2010, FirmwareType.RF_BI_DIRECTIONAL_DEVICES, DeviceDescriptorMediumType.RF),

  RF_UNI_DIRECTIONAL_DEVICES((int) 0x2110, FirmwareType.RF_UNI_DIRECTIONAL_DEVICES, DeviceDescriptorMediumType.RF),
  ...
  public static DeviceDescriptor firstEnumForFieldFirmwareType(FirmwareType firmwareType) {
    for (DeviceDescriptor _val : DeviceDescriptor.values()) {
      if (_val.getFirmwareType() == firmwareType) {
        return _val;
      }
    }
    return null;
  ...
  public static DeviceDescriptor firstEnumForFieldMediumType(
      DeviceDescriptorMediumType mediumType) {
    for (DeviceDescriptor _val : DeviceDescriptor.values()) {
      if (_val.getMediumType() == mediumType) {
        return _val;
      }
    }
    return null;
