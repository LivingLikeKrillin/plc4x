...
public enum TypeIdentification {
  ...
  PACKED_OUTPUT_CIRCUIT_INFORMATION_OF_PROTECTION_EQUIPMENT_WITH_TIME_TAG_CP56TIME2A((short) 0x28, (byte) 7),
  ...
  MEASURED_VALUE_SHORT_FLOATING_POINT_NUMBER_COMMAND_WITH_TIME_TAG_CP56TIME2A((short) 0x3F, (byte) 7),
  ...
  public static TypeIdentification firstEnumForFieldNumTimeBytes(byte numTimeBytes) {
    for (TypeIdentification _val : TypeIdentification.values()) {
      if (_val.getNumTimeBytes() == numTimeBytes) {
        return _val;
      }
    }
    return null;
  ...
  public static List<TypeIdentification> enumsForFieldNumTimeBytes(byte numTimeBytes) {
