 ...
 */
public class InformationObjectWithoutTime_PARAMETER_ACTIVATION extends InformationObjectWithoutTime implements Message {
  protected final QualifierOfParameterActivation qpa;

  public InformationObjectWithoutTime_PARAMETER_ACTIVATION(Integer address,
  ...
  public static class InformationObjectWithoutTimeBuilderImpl implements InformationObjectWithoutTime.InformationObjectWithoutTimeBuilder {
    ...
    public InformationObjectWithoutTimeBuilderImpl(QualifierOfParameterActivation qpa) {
      this.qpa = qpa;
    }

    public InformationObjectWithoutTime build(int address) {
      return new InformationObjectWithoutTime_PARAMETER_ACTIVATION(address, qpa);
    }
  }
}
