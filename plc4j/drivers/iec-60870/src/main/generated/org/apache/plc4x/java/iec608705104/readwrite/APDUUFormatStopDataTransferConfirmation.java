...
public class APDUUFormatStopDataTransferConfirmation extends APDU implements Message {
  public APDUUFormatStopDataTransferConfirmation(Integer command) {
    super(command);
  }
  ...
  public int getLengthInBits() {
    ...
    APDUUFormatStopDataTransferConfirmation _value = this;
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
    // Padding Field: padding0
  ...
  public static class APDUBuilderImpl implements APDU.APDUBuilder {
    ...
    public APDU build(int command) {
      return new APDUUFormatStopDataTransferConfirmation(command);
    }
  }
}
