 ...
 */
public class InformationObjectWithTreeByteTime_MEASURED_VALUE_SHORT_FLOATING_POINT_NUMBER extends InformationObjectWithTreeByteTime implements Message {
  ...
  public InformationObjectWithTreeByteTime_MEASURED_VALUE_SHORT_FLOATING_POINT_NUMBER(
      Integer address, Float value, QualityDescriptor qds, ThreeOctetBinaryTime cp24Time2a) {
    super(address);
    this.value = value;
    this.qds = qds;
  ...
  public TypeIdentification getTypeIdentification() {
    return TypeIdentification.MEASURED_VALUE_SHORT_FLOATING_POINT_NUMBER_WITH_TIME_TAG;
  }
  ...
  public static InformationObjectWithTreeByteTimeBuilder staticParseInformationObjectWithTreeByteTimeBuilder(
      ...
      BufferException {
    readBuffer.pushContext(WithOption.WithName("InformationObjectWithTreeByteTime_MEASURED_VALUE_SHORT_FLOATING_POINT_NUMBER"), WithOption.WithFloatEncoding("IEEE754"), WithOption.WithSignedIntegerEncoding("twos-complement"), WithOption.WithUnsignedIntegerEncoding("unsigned-binary"), WithByteBasedOption.WithByteOrder("LITTLE_ENDIAN"), WithOption.WithStringEncoding("UTF8"));
    ...
    return new InformationObjectWithTreeByteTimeBuilderImpl(value, qds, cp24Time2a);
  }

  protected void serializeInformationObjectWithTreeByteTimeChild(WriteBuffer writeBuffer) throws
      BufferException {
    writeBuffer.pushContext(WithOption.WithName("InformationObjectWithTreeByteTime_MEASURED_VALUE_SHORT_FLOATING_POINT_NUMBER"), WithOption.WithFloatEncoding("IEEE754"), WithOption.WithSignedIntegerEncoding("twos-complement"), WithOption.WithUnsignedIntegerEncoding("unsigned-binary"), WithByteBasedOption.WithByteOrder("LITTLE_ENDIAN"), WithOption.WithStringEncoding("UTF8"));
  ...
  public int getLengthInBits() {
    ...
    InformationObjectWithTreeByteTime_MEASURED_VALUE_SHORT_FLOATING_POINT_NUMBER _value = this;
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
    // Simple Field: value
    lengthInBits += 32;
  ...
  public static class InformationObjectWithTreeByteTimeBuilderImpl implements InformationObjectWithTreeByteTime.InformationObjectWithTreeByteTimeBuilder {
    ...
    public InformationObjectWithTreeByteTimeBuilderImpl(float value, QualityDescriptor qds,
    ...
    public InformationObjectWithTreeByteTime build(int address) {
      return new InformationObjectWithTreeByteTime_MEASURED_VALUE_SHORT_FLOATING_POINT_NUMBER(address, value, qds, cp24Time2a);
    }
  }
}
