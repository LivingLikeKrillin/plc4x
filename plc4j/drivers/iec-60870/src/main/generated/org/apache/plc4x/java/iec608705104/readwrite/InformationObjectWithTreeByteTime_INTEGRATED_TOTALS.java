 ...
 */
public class InformationObjectWithTreeByteTime_INTEGRATED_TOTALS extends InformationObjectWithTreeByteTime implements Message {
  protected final BinaryCounterReading bcr;

  protected final ThreeOctetBinaryTime cp24Time2a;

  public InformationObjectWithTreeByteTime_INTEGRATED_TOTALS(Integer address,
  ...
  public static InformationObjectWithTreeByteTimeBuilder staticParseInformationObjectWithTreeByteTimeBuilder(
      ...
      BufferException {
    readBuffer.pushContext(WithOption.WithName("InformationObjectWithTreeByteTime_INTEGRATED_TOTALS"), WithOption.WithFloatEncoding("IEEE754"), WithOption.WithSignedIntegerEncoding("twos-complement"), WithOption.WithUnsignedIntegerEncoding("unsigned-binary"), WithByteBasedOption.WithByteOrder("LITTLE_ENDIAN"), WithOption.WithStringEncoding("UTF8"));
  ...
  protected void serializeInformationObjectWithTreeByteTimeChild(WriteBuffer writeBuffer) throws
      BufferException {
    writeBuffer.pushContext(WithOption.WithName("InformationObjectWithTreeByteTime_INTEGRATED_TOTALS"), WithOption.WithFloatEncoding("IEEE754"), WithOption.WithSignedIntegerEncoding("twos-complement"), WithOption.WithUnsignedIntegerEncoding("unsigned-binary"), WithByteBasedOption.WithByteOrder("LITTLE_ENDIAN"), WithOption.WithStringEncoding("UTF8"));
  ...
  public static class InformationObjectWithTreeByteTimeBuilderImpl implements InformationObjectWithTreeByteTime.InformationObjectWithTreeByteTimeBuilder {
    ...
    public InformationObjectWithTreeByteTimeBuilderImpl(BinaryCounterReading bcr,
    ...
    public InformationObjectWithTreeByteTime build(int address) {
      return new InformationObjectWithTreeByteTime_INTEGRATED_TOTALS(address, bcr, cp24Time2a);
    }
  }
}
