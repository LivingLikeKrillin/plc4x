 ...
 */
public class QualifierOfParameterActivation implements Message {
  protected final short qualifier;

  public QualifierOfParameterActivation(Short qualifier) {
  ...
  public int getLengthInBits() {
    int lengthInBits = 0;
    QualifierOfParameterActivation _value = this;
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
    // Simple Field: qualifier
    lengthInBits += 8;
