 ...
 */
public class InformationObjectWithoutTime_TEST_COMMAND extends InformationObjectWithoutTime implements Message {
  protected final FixedTestBitPatternTwoOctet fbp;

  public InformationObjectWithoutTime_TEST_COMMAND(Integer address,
  ...
  public static class InformationObjectWithoutTimeBuilderImpl implements InformationObjectWithoutTime.InformationObjectWithoutTimeBuilder {
    ...
    public InformationObjectWithoutTimeBuilderImpl(FixedTestBitPatternTwoOctet fbp) {
      this.fbp = fbp;
    }

    public InformationObjectWithoutTime build(int address) {
      return new InformationObjectWithoutTime_TEST_COMMAND(address, fbp);
    }
  }
}
