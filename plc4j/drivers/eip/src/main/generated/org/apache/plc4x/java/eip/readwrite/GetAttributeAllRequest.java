...
public class GetAttributeAllRequest extends CipService implements Message {
  ...
  public static CipServiceBuilder staticParseCipServiceBuilder(ReadBuffer readBuffer,
    ...
    readBuffer.pushContext(WithOption.WithName("GetAttributeAllRequest"));
    ...
    return new CipServiceBuilderImpl(classSegment, instanceSegment);
  }

  protected void serializeCipServiceChild(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("GetAttributeAllRequest"));
  ...
  public static class CipServiceBuilderImpl implements CipService.CipServiceBuilder {
    ...
    public CipService build() {
      return new GetAttributeAllRequest(classSegment, instanceSegment);
    }
  }
}
