 ...
 */
public class GetAttributeListResponse extends CipService implements Message {
  ...
  public static CipServiceBuilder staticParseCipServiceBuilder(ReadBuffer readBuffer,
    ...
    readBuffer.pushContext(WithOption.WithName("GetAttributeListResponse"));
  ...
  protected void serializeCipServiceChild(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("GetAttributeListResponse"));
  ...
  public int getLengthInBits() {
    ...
    GetAttributeListResponse _value = this;
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
    return lengthInBits;
  }
