...
public abstract class CommandSpecificDataItem implements Message {
  ...
  protected abstract void serializeCommandSpecificDataItemChild(WriteBuffer writeBuffer) throws
      BufferException;

  public static CommandSpecificDataItem staticParse(ReadBuffer readBuffer) throws BufferException {
    readBuffer.pushContext(WithOption.WithName("CommandSpecificDataItem"));
    int startPos = readBuffer.getPositionInBits();
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
    // Discriminator Field: itemType
    int itemType = FieldReaderFactory.readDiscriminatorField(DataReaderFactory.readUnsignedInt(readBuffer, 16), WithOption.WithName("itemType"));
  ...
  public void serialize(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("CommandSpecificDataItem"));
    int startPos = writeBuffer.getPositionInBits();
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
    int itemType = (int) getItemType();
    // Discriminator Field: itemType
    FieldWriterFactory.writeDiscriminatorField((int) itemType, DataWriterFactory.writeUnsignedInt(writeBuffer, 16), WithOption.WithName("itemType"));
