...
public class CIPData implements Message {
  ...
  public static CIPData staticParse(ReadBuffer readBuffer, int packetLength) throws
      BufferException {
    readBuffer.pushContext(WithOption.WithName("CIPData"));
    ...
    // Array Field: data
    byte[] data = readBuffer.readBits(Math.toIntExact(((packetLength) - (2)) * 8), WithOption.WithName("data"));

    readBuffer.popContext();
    return new CIPData(dataType, data);
  }

  @Override
  public void serialize(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("CIPData"));
