...
public class BACnetPropertyStatesSilencedState extends BACnetPropertyStates implements Message {
  ...
  public BACnetPropertyStatesSilencedState(BACnetTagHeader peekedTagHeader,
  ...
  public static BACnetPropertyStatesBuilder staticParseBACnetPropertyStatesBuilder(
    ...
    readBuffer.pushContext(WithOption.WithName("BACnetPropertyStatesSilencedState"));
  ...
  protected void serializeBACnetPropertyStatesChild(WriteBuffer writeBuffer) throws
      BufferException {
    writeBuffer.pushContext(WithOption.WithName("BACnetPropertyStatesSilencedState"));
    int startPos = writeBuffer.getPositionInBits();
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
    // Simple Field: silencedState
    FieldWriterFactory.writeSimpleField((BACnetSilencedStateTagged) silencedState, DataWriterFactory.writeComplex(writeBuffer), WithOption.WithName("silencedState"));
  ...
  public static class BACnetPropertyStatesBuilderImpl implements BACnetPropertyStates.BACnetPropertyStatesBuilder {
    ...
    public BACnetPropertyStatesBuilderImpl(BACnetSilencedStateTagged silencedState) {
      this.silencedState = silencedState;
    }

    public BACnetPropertyStates build(BACnetTagHeader peekedTagHeader) {
      return new BACnetPropertyStatesSilencedState(peekedTagHeader, silencedState);
    }
  }
}
