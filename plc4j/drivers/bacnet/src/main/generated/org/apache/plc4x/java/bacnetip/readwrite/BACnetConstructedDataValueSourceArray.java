 ...
 */
public class BACnetConstructedDataValueSourceArray extends BACnetConstructedData implements Message {
  protected final BACnetApplicationTagUnsignedInteger numberOfDataElements;

  protected final List<BACnetValueSource> vtClassesSupported;

  public BACnetConstructedDataValueSourceArray(BACnetOpeningTag openingTag,
  ...
  public static BACnetConstructedDataBuilder staticParseBACnetConstructedDataBuilder(
    ...
    readBuffer.pushContext(WithOption.WithName("BACnetConstructedDataValueSourceArray"));
    ...
    if(!(((arrayIndexArgument) != (null)) || ((org.apache.plc4x.java.spi.utils.StaticHelper.COUNT(vtClassesSupported)) == (16)))) {
      throw new ParseAssertException("vtClassesSupported should have exactly 16 values");
    }

    readBuffer.popContext();
    return new BACnetConstructedDataBuilderImpl(numberOfDataElements, vtClassesSupported);
  }

  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer) throws
      BufferException {
    writeBuffer.pushContext(WithOption.WithName("BACnetConstructedDataValueSourceArray"));
  ...
  public static class BACnetConstructedDataBuilderImpl implements BACnetConstructedData.BACnetConstructedDataBuilder {
    ...
    public BACnetConstructedData build(BACnetOpeningTag openingTag, BACnetTagHeader peekedTagHeader,
      ...
      return new BACnetConstructedDataValueSourceArray(openingTag, peekedTagHeader, closingTag, numberOfDataElements, vtClassesSupported);
    }
  }
}
