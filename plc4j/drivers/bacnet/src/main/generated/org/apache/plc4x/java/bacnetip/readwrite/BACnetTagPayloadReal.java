...
public class BACnetTagPayloadReal implements Message {
  ...
  public static BACnetTagPayloadReal staticParse(ReadBuffer readBuffer) throws BufferException {
    readBuffer.pushContext(WithOption.WithName("BACnetTagPayloadReal"));
    ...
    return new BACnetTagPayloadReal(value);
  }

  @Override
  public void serialize(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("BACnetTagPayloadReal"));
