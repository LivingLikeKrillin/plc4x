 ...
 */
public class ErrorEnclosed implements Message {
  ...
  public static ErrorEnclosed staticParse(ReadBuffer readBuffer, short tagNumber) throws
      BufferException {
    readBuffer.pushContext(WithOption.WithName("ErrorEnclosed"));
    ...
    return new ErrorEnclosed(openingTag, error, closingTag);
  }

  @Override
  public void serialize(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("ErrorEnclosed"));
