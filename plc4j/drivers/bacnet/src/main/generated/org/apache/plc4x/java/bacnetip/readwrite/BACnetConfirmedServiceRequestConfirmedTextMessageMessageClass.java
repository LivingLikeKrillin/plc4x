 ...
 */
public abstract class BACnetConfirmedServiceRequestConfirmedTextMessageMessageClass implements Message {
  ...
  public BACnetConfirmedServiceRequestConfirmedTextMessageMessageClass(BACnetOpeningTag openingTag,
  ...
  protected abstract void serializeBACnetConfirmedServiceRequestConfirmedTextMessageMessageClassChild(
  ...
  public static BACnetConfirmedServiceRequestConfirmedTextMessageMessageClass staticParse(
    ...
    readBuffer.pushContext(WithOption.WithName("BACnetConfirmedServiceRequestConfirmedTextMessageMessageClass"));
    ...
    if (EvaluationHelper.equals(peekedTagNumber, (short) (0))) {
      builder = BACnetConfirmedServiceRequestConfirmedTextMessageMessageClassNumeric.staticParseBACnetConfirmedServiceRequestConfirmedTextMessageMessageClassBuilder(readBuffer, tagNumber);
    } else if (EvaluationHelper.equals(peekedTagNumber, (short) (1))) {
      builder = BACnetConfirmedServiceRequestConfirmedTextMessageMessageClassCharacter.staticParseBACnetConfirmedServiceRequestConfirmedTextMessageMessageClassBuilder(readBuffer, tagNumber);
    }
    if (builder == null) {
  ...
  public void serialize(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("BACnetConfirmedServiceRequestConfirmedTextMessageMessageClass"));
  ...
  public interface BACnetConfirmedServiceRequestConfirmedTextMessageMessageClassBuilder {
    BACnetConfirmedServiceRequestConfirmedTextMessageMessageClass build(BACnetOpeningTag openingTag,
        BACnetTagHeader peekedTagHeader, BACnetClosingTag closingTag);
  }
}
