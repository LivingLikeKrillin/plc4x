 ...
 */
public abstract class BACnetShedLevel implements Message {
  protected final BACnetTagHeader peekedTagHeader;

  public BACnetShedLevel(BACnetTagHeader peekedTagHeader) {
    this.peekedTagHeader = peekedTagHeader;
  }

  protected abstract void serializeBACnetShedLevelChild(WriteBuffer writeBuffer) throws
      BufferException;
  ...
  public static BACnetShedLevel staticParse(ReadBuffer readBuffer) throws BufferException {
    readBuffer.pushContext(WithOption.WithName("BACnetShedLevel"));
  ...
  public void serialize(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("BACnetShedLevel"));
    ...
    // Switch Field
    serializeBACnetShedLevelChild(writeBuffer);
