...
public class BACnetRouterEntryStatusTagged implements Message {
  ...
  public static BACnetRouterEntryStatusTagged staticParse(ReadBuffer readBuffer, short tagNumber,
      TagClass tagClass) throws BufferException {
    readBuffer.pushContext(WithOption.WithName("BACnetRouterEntryStatusTagged"));
    ...
    // Manual Field: value
    BACnetRouterEntryStatus value = FieldReaderFactory.readManualField(readBuffer, () -> (BACnetRouterEntryStatus) (StaticHelper.readEnumGenericFailing(readBuffer, header.getActualLength(), BACnetRouterEntryStatus.AVAILABLE)), WithOption.WithName("value"));

    readBuffer.popContext();
    return new BACnetRouterEntryStatusTagged(header, value);
  }

  @Override
  public void serialize(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("BACnetRouterEntryStatusTagged"));
