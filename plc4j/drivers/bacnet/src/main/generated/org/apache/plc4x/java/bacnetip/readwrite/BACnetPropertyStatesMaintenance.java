...
public class BACnetPropertyStatesMaintenance extends BACnetPropertyStates implements Message {
  ...
  public BACnetPropertyStatesMaintenance(BACnetTagHeader peekedTagHeader,
  ...
  public static BACnetPropertyStatesBuilder staticParseBACnetPropertyStatesBuilder(
    ...
    readBuffer.pushContext(WithOption.WithName("BACnetPropertyStatesMaintenance"));
  ...
  protected void serializeBACnetPropertyStatesChild(WriteBuffer writeBuffer) throws
      BufferException {
    writeBuffer.pushContext(WithOption.WithName("BACnetPropertyStatesMaintenance"));
    int startPos = writeBuffer.getPositionInBits();
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
    // Simple Field: maintenance
    FieldWriterFactory.writeSimpleField((BACnetMaintenanceTagged) maintenance, DataWriterFactory.writeComplex(writeBuffer), WithOption.WithName("maintenance"));
  ...
  public static class BACnetPropertyStatesBuilderImpl implements BACnetPropertyStates.BACnetPropertyStatesBuilder {
    ...
    public BACnetPropertyStatesBuilderImpl(BACnetMaintenanceTagged maintenance) {
      this.maintenance = maintenance;
    }

    public BACnetPropertyStates build(BACnetTagHeader peekedTagHeader) {
      return new BACnetPropertyStatesMaintenance(peekedTagHeader, maintenance);
    }
  }
}
