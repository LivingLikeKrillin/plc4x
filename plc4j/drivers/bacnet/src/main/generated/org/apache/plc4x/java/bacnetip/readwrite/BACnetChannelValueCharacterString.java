...
public class BACnetChannelValueCharacterString extends BACnetChannelValue implements Message {
  ...
  public BACnetChannelValueCharacterString(BACnetTagHeader peekedTagHeader,
  ...
  public static BACnetChannelValueBuilder staticParseBACnetChannelValueBuilder(
    ...
    readBuffer.pushContext(WithOption.WithName("BACnetChannelValueCharacterString"));
    ...
    return new BACnetChannelValueBuilderImpl(characterStringValue);
  }

  protected void serializeBACnetChannelValueChild(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("BACnetChannelValueCharacterString"));
  ...
  public static class BACnetChannelValueBuilderImpl implements BACnetChannelValue.BACnetChannelValueBuilder {
    ...
    public BACnetChannelValueBuilderImpl(BACnetApplicationTagCharacterString characterStringValue) {
      this.characterStringValue = characterStringValue;
    }

    public BACnetChannelValue build(BACnetTagHeader peekedTagHeader) {
      return new BACnetChannelValueCharacterString(peekedTagHeader, characterStringValue);
    }
  }
}
