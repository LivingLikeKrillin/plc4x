...
public class BACnetPriorityValueDateTime extends BACnetPriorityValue implements Message {
  ...
  public BACnetPriorityValueDateTime(BACnetTagHeader peekedTagHeader,
  ...
  public static BACnetPriorityValueBuilder staticParseBACnetPriorityValueBuilder(
    ...
    readBuffer.pushContext(WithOption.WithName("BACnetPriorityValueDateTime"));
  ...
  protected void serializeBACnetPriorityValueChild(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("BACnetPriorityValueDateTime"));
  ...
  public static class BACnetPriorityValueBuilderImpl implements BACnetPriorityValue.BACnetPriorityValueBuilder {
    ...
    public BACnetPriorityValueBuilderImpl(BACnetDateTimeEnclosed dateTimeValue) {
      this.dateTimeValue = dateTimeValue;
    }

    public BACnetPriorityValue build(BACnetTagHeader peekedTagHeader) {
      return new BACnetPriorityValueDateTime(peekedTagHeader, dateTimeValue);
    }
  }
}
