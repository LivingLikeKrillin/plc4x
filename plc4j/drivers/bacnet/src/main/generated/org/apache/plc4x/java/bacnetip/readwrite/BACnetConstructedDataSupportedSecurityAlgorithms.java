 ...
 */
public class BACnetConstructedDataSupportedSecurityAlgorithms extends BACnetConstructedData implements Message {
  protected final List<BACnetApplicationTagUnsignedInteger> supportedSecurityAlgorithms;

  public BACnetConstructedDataSupportedSecurityAlgorithms(BACnetOpeningTag openingTag,
  ...
  /**
   * Property field supportedSecurityAlgorithms
   */
  ...
  public static BACnetConstructedDataBuilder staticParseBACnetConstructedDataBuilder(
    ...
    readBuffer.pushContext(WithOption.WithName("BACnetConstructedDataSupportedSecurityAlgorithms"));
  ...
  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer) throws
      BufferException {
    writeBuffer.pushContext(WithOption.WithName("BACnetConstructedDataSupportedSecurityAlgorithms"));
    int startPos = writeBuffer.getPositionInBits();
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
    // Array Field: supportedSecurityAlgorithms
    FieldWriterFactory.writeComplexTypeArrayField(supportedSecurityAlgorithms, writeBuffer, WithOption.WithName("supportedSecurityAlgorithms"));
  ...
  public int getLengthInBits() {
    ...
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
    // Array Field: supportedSecurityAlgorithms
    for (Message _element : supportedSecurityAlgorithms) {
  ...
  public static class BACnetConstructedDataBuilderImpl implements BACnetConstructedData.BACnetConstructedDataBuilder {
    ...
    public BACnetConstructedData build(BACnetOpeningTag openingTag, BACnetTagHeader peekedTagHeader,
      ...
      return new BACnetConstructedDataSupportedSecurityAlgorithms(openingTag, peekedTagHeader, closingTag, supportedSecurityAlgorithms);
    }
  }
}
