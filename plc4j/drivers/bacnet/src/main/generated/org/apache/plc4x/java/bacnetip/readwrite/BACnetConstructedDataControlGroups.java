...
public class BACnetConstructedDataControlGroups extends BACnetConstructedData implements Message {
  ...
  public BACnetConstructedDataControlGroups(BACnetOpeningTag openingTag,
  ...
  public static BACnetConstructedDataBuilder staticParseBACnetConstructedDataBuilder(
    ...
    readBuffer.pushContext(WithOption.WithName("BACnetConstructedDataControlGroups"));
    ...
    List<BACnetApplicationTagUnsignedInteger> controlGroups = FieldReaderFactory.readTerminatedArrayField(DataReaderFactory.readComplex(() -> (BACnetApplicationTagUnsignedInteger) BACnetApplicationTagUnsignedInteger.staticParse(readBuffer), readBuffer), () -> (boolean) StaticHelper.isBACnetConstructedDataClosingTag(readBuffer, false, tagNumber), WithOption.WithName("controlGroups"));

    readBuffer.popContext();
    return new BACnetConstructedDataBuilderImpl(numberOfDataElements, controlGroups);
  }

  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer) throws
      BufferException {
    writeBuffer.pushContext(WithOption.WithName("BACnetConstructedDataControlGroups"));
    ...
    // Array Field: controlGroups
    FieldWriterFactory.writeComplexTypeArrayField(controlGroups, writeBuffer, WithOption.WithName("controlGroups"));
  ...
  public int getLengthInBits() {
    ...
    // Array Field: controlGroups
    for (Message _element : controlGroups) {
  ...
  public static class BACnetConstructedDataBuilderImpl implements BACnetConstructedData.BACnetConstructedDataBuilder {
    ...
    public BACnetConstructedData build(BACnetOpeningTag openingTag, BACnetTagHeader peekedTagHeader,
      ...
      return new BACnetConstructedDataControlGroups(openingTag, peekedTagHeader, closingTag, numberOfDataElements, controlGroups);
    }
  }
}
