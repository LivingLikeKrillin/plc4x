...
public class BACnetTimerStateChangeValueDate extends BACnetTimerStateChangeValue implements Message {
  ...
  public BACnetTimerStateChangeValueDate(BACnetTagHeader peekedTagHeader,
  ...
  public static BACnetTimerStateChangeValueBuilder staticParseBACnetTimerStateChangeValueBuilder(
    ...
    readBuffer.pushContext(WithOption.WithName("BACnetTimerStateChangeValueDate"));
  ...
  protected void serializeBACnetTimerStateChangeValueChild(WriteBuffer writeBuffer) throws
      BufferException {
    writeBuffer.pushContext(WithOption.WithName("BACnetTimerStateChangeValueDate"));
  ...
  public static class BACnetTimerStateChangeValueBuilderImpl implements BACnetTimerStateChangeValue.BACnetTimerStateChangeValueBuilder {
    ...
    public BACnetTimerStateChangeValueBuilderImpl(BACnetApplicationTagDate dateValue) {
      this.dateValue = dateValue;
    }

    public BACnetTimerStateChangeValue build(BACnetTagHeader peekedTagHeader) {
      return new BACnetTimerStateChangeValueDate(peekedTagHeader, dateValue);
    }
  }
}
