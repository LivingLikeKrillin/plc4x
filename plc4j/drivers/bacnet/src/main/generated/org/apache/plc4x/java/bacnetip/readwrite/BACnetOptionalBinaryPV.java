 ...
 */
public abstract class BACnetOptionalBinaryPV implements Message {
  protected final BACnetTagHeader peekedTagHeader;

  public BACnetOptionalBinaryPV(BACnetTagHeader peekedTagHeader) {
    this.peekedTagHeader = peekedTagHeader;
  }

  protected abstract void serializeBACnetOptionalBinaryPVChild(WriteBuffer writeBuffer) throws
      BufferException;
  ...
  public static BACnetOptionalBinaryPV staticParse(ReadBuffer readBuffer) throws BufferException {
    readBuffer.pushContext(WithOption.WithName("BACnetOptionalBinaryPV"));
  ...
  public void serialize(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("BACnetOptionalBinaryPV"));
    ...
    // Switch Field
    serializeBACnetOptionalBinaryPVChild(writeBuffer);
  ...
  public int getLengthInBits() {
    int lengthInBits = 0;
    BACnetOptionalBinaryPV _value = this;
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
    // Peek Field: peekedTagHeader
