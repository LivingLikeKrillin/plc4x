 ...
 */
public class BACnetPropertyStatesLightningOperation extends BACnetPropertyStates implements Message {
  protected final BACnetLightingOperationTagged lightningOperation;

  public BACnetPropertyStatesLightningOperation(BACnetTagHeader peekedTagHeader,
  ...
  public static BACnetPropertyStatesBuilder staticParseBACnetPropertyStatesBuilder(
    ...
    readBuffer.pushContext(WithOption.WithName("BACnetPropertyStatesLightningOperation"));
  ...
  protected void serializeBACnetPropertyStatesChild(WriteBuffer writeBuffer) throws
      BufferException {
    writeBuffer.pushContext(WithOption.WithName("BACnetPropertyStatesLightningOperation"));
  ...
  public static class BACnetPropertyStatesBuilderImpl implements BACnetPropertyStates.BACnetPropertyStatesBuilder {
    ...
    public BACnetPropertyStatesBuilderImpl(BACnetLightingOperationTagged lightningOperation) {
      this.lightningOperation = lightningOperation;
    }

    public BACnetPropertyStates build(BACnetTagHeader peekedTagHeader) {
      return new BACnetPropertyStatesLightningOperation(peekedTagHeader, lightningOperation);
    }
  }
}
