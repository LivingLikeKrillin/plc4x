...
public class BACnetRecipientAddress extends BACnetRecipient implements Message {
  ...
  public BACnetRecipientAddress(BACnetTagHeader peekedTagHeader,
  ...
  public static BACnetRecipientBuilder staticParseBACnetRecipientBuilder(ReadBuffer readBuffer)
    ...
    readBuffer.pushContext(WithOption.WithName("BACnetRecipientAddress"));
  ...
  protected void serializeBACnetRecipientChild(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("BACnetRecipientAddress"));
    int startPos = writeBuffer.getPositionInBits();
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
    // Simple Field: addressValue
    FieldWriterFactory.writeSimpleField((BACnetAddressEnclosed) addressValue, DataWriterFactory.writeComplex(writeBuffer), WithOption.WithName("addressValue"));
  ...
  public static class BACnetRecipientBuilderImpl implements BACnetRecipient.BACnetRecipientBuilder {
    ...
    public BACnetRecipientBuilderImpl(BACnetAddressEnclosed addressValue) {
      this.addressValue = addressValue;
    }

    public BACnetRecipient build(BACnetTagHeader peekedTagHeader) {
      return new BACnetRecipientAddress(peekedTagHeader, addressValue);
    }
  }
}
