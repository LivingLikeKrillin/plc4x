...
public abstract class BACnetPropertyAccessResultAccessResult implements Message {
  ...
  public static BACnetPropertyAccessResultAccessResult staticParse(ReadBuffer readBuffer,
    ...
    readBuffer.pushContext(WithOption.WithName("BACnetPropertyAccessResultAccessResult"));
    ...
    if (EvaluationHelper.equals(peekedTagNumber, (short) (4))) {
      builder = BACnetPropertyAccessResultAccessResultPropertyValue.staticParseBACnetPropertyAccessResultAccessResultBuilder(readBuffer, objectTypeArgument, propertyIdentifierArgument, propertyArrayIndexArgument);
    } else if (EvaluationHelper.equals(peekedTagNumber, (short) (5))) {
      builder = BACnetPropertyAccessResultAccessResultPropertyAccessError.staticParseBACnetPropertyAccessResultAccessResultBuilder(readBuffer, objectTypeArgument, propertyIdentifierArgument, propertyArrayIndexArgument);
    }
    if (builder == null) {
  ...
  public void serialize(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("BACnetPropertyAccessResultAccessResult"));
