...
public abstract class BACnetLogData implements Message {
  ...
  public BACnetLogData(BACnetOpeningTag openingTag, BACnetTagHeader peekedTagHeader,
  ...
  protected abstract void serializeBACnetLogDataChild(WriteBuffer writeBuffer) throws
      BufferException;
  ...
  public static BACnetLogData staticParse(ReadBuffer readBuffer, short tagNumber) throws
      BufferException {
    readBuffer.pushContext(WithOption.WithName("BACnetLogData"));
    ...
    if (EvaluationHelper.equals(peekedTagNumber, (short) (0))) {
      ...
      builder = BACnetLogDataLogDataTimeChange.staticParseBACnetLogDataBuilder(readBuffer, tagNumber);
    }
    if (builder == null) {
  ...
  public void serialize(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("BACnetLogData"));
  ...
  public interface BACnetLogDataBuilder {
    BACnetLogData build(BACnetOpeningTag openingTag, BACnetTagHeader peekedTagHeader,
        BACnetClosingTag closingTag);
  }
}
