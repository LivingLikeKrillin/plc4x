 ...
 */
public class BACnetConstructedDataCommandTimeArray extends BACnetConstructedData implements Message {
  protected final BACnetApplicationTagUnsignedInteger numberOfDataElements;

  protected final List<BACnetTimeStamp> commandTimeArray;

  public BACnetConstructedDataCommandTimeArray(BACnetOpeningTag openingTag,
  ...
  /**
   * Property field commandTimeArray
   */
  ...
  public static BACnetConstructedDataBuilder staticParseBACnetConstructedDataBuilder(
    ...
    readBuffer.pushContext(WithOption.WithName("BACnetConstructedDataCommandTimeArray"));
    ...
    if(!(((arrayIndexArgument) != (null)) || ((org.apache.plc4x.java.spi.utils.StaticHelper.COUNT(commandTimeArray)) == (16)))) {
      throw new ParseAssertException("commandTimeArray should have exactly 16 values");
    }

    readBuffer.popContext();
    return new BACnetConstructedDataBuilderImpl(numberOfDataElements, commandTimeArray);
  }

  protected void serializeBACnetConstructedDataChild(WriteBuffer writeBuffer) throws
      BufferException {
    writeBuffer.pushContext(WithOption.WithName("BACnetConstructedDataCommandTimeArray"));
    ...
    // Array Field: commandTimeArray
    FieldWriterFactory.writeComplexTypeArrayField(commandTimeArray, writeBuffer, WithOption.WithName("commandTimeArray"));
  ...
  public int getLengthInBits() {
    ...
    // Array Field: commandTimeArray
    for (Message _element : commandTimeArray) {
  ...
  public static class BACnetConstructedDataBuilderImpl implements BACnetConstructedData.BACnetConstructedDataBuilder {
    ...
    public BACnetConstructedData build(BACnetOpeningTag openingTag, BACnetTagHeader peekedTagHeader,
      ...
      return new BACnetConstructedDataCommandTimeArray(openingTag, peekedTagHeader, closingTag, numberOfDataElements, commandTimeArray);
    }
  }
}
