...
public class BACnetPropertyStatesDoorAlarmState extends BACnetPropertyStates implements Message {
  ...
  public BACnetPropertyStatesDoorAlarmState(BACnetTagHeader peekedTagHeader,
  ...
  public static BACnetPropertyStatesBuilder staticParseBACnetPropertyStatesBuilder(
    ...
    readBuffer.pushContext(WithOption.WithName("BACnetPropertyStatesDoorAlarmState"));
  ...
  protected void serializeBACnetPropertyStatesChild(WriteBuffer writeBuffer) throws
      BufferException {
    writeBuffer.pushContext(WithOption.WithName("BACnetPropertyStatesDoorAlarmState"));
  ...
  public static class BACnetPropertyStatesBuilderImpl implements BACnetPropertyStates.BACnetPropertyStatesBuilder {
    ...
    public BACnetPropertyStatesBuilderImpl(BACnetDoorAlarmStateTagged doorAlarmState) {
      this.doorAlarmState = doorAlarmState;
    }

    public BACnetPropertyStates build(BACnetTagHeader peekedTagHeader) {
      return new BACnetPropertyStatesDoorAlarmState(peekedTagHeader, doorAlarmState);
    }
  }
}
