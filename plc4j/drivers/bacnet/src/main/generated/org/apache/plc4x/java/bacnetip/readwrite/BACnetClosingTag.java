...
public class BACnetClosingTag implements Message {
  ...
  public static BACnetClosingTag staticParse(ReadBuffer readBuffer, short tagNumberArgument) throws
      BufferException {
    readBuffer.pushContext(WithOption.WithName("BACnetClosingTag"));
    ...
    if(!((header.getLengthValueType()) == (7))) {
      throw new ParseAssertException("closing tag should have a value of 7");
    }
  ...
  public void serialize(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("BACnetClosingTag"));
