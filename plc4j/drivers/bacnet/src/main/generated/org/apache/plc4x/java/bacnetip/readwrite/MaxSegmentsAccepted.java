...
public enum MaxSegmentsAccepted {
  ...
  public static MaxSegmentsAccepted firstEnumForFieldMaxSegments(short maxSegments) {
    for (MaxSegmentsAccepted _val : MaxSegmentsAccepted.values()) {
      if (_val.getMaxSegments() == maxSegments) {
        return _val;
      }
    }
    return null;
  ...
  public static List<MaxSegmentsAccepted> enumsForFieldMaxSegments(short maxSegments) {
