...
public class BACnetTimeStampTime extends BACnetTimeStamp implements Message {
  ...
  public static BACnetTimeStampBuilder staticParseBACnetTimeStampBuilder(ReadBuffer readBuffer)
    ...
    readBuffer.pushContext(WithOption.WithName("BACnetTimeStampTime"));
  ...
  protected void serializeBACnetTimeStampChild(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("BACnetTimeStampTime"));
    int startPos = writeBuffer.getPositionInBits();
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
    // Simple Field: timeValue
    FieldWriterFactory.writeSimpleField((BACnetContextTagTime) timeValue, DataWriterFactory.writeComplex(writeBuffer), WithOption.WithName("timeValue"));
  ...
  public static class BACnetTimeStampBuilderImpl implements BACnetTimeStamp.BACnetTimeStampBuilder {
    ...
    public BACnetTimeStampBuilderImpl(BACnetContextTagTime timeValue) {
      this.timeValue = timeValue;
    }

    public BACnetTimeStamp build(BACnetTagHeader peekedTagHeader) {
      return new BACnetTimeStampTime(peekedTagHeader, timeValue);
    }
  }
}
