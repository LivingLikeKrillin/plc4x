...
public class BACnetChannelValueEnumerated extends BACnetChannelValue implements Message {
  ...
  public BACnetChannelValueEnumerated(BACnetTagHeader peekedTagHeader,
  ...
  public static BACnetChannelValueBuilder staticParseBACnetChannelValueBuilder(
    ...
    readBuffer.pushContext(WithOption.WithName("BACnetChannelValueEnumerated"));
    ...
    return new BACnetChannelValueBuilderImpl(enumeratedValue);
  }

  protected void serializeBACnetChannelValueChild(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("BACnetChannelValueEnumerated"));
  ...
  public static class BACnetChannelValueBuilderImpl implements BACnetChannelValue.BACnetChannelValueBuilder {
    ...
    public BACnetChannelValueBuilderImpl(BACnetApplicationTagEnumerated enumeratedValue) {
      this.enumeratedValue = enumeratedValue;
    }

    public BACnetChannelValue build(BACnetTagHeader peekedTagHeader) {
      return new BACnetChannelValueEnumerated(peekedTagHeader, enumeratedValue);
    }
  }
}
