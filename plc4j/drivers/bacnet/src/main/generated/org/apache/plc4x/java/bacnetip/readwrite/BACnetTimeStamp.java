 ...
 */
public abstract class BACnetTimeStamp implements Message {
  protected final BACnetTagHeader peekedTagHeader;

  public BACnetTimeStamp(BACnetTagHeader peekedTagHeader) {
    this.peekedTagHeader = peekedTagHeader;
  }

  protected abstract void serializeBACnetTimeStampChild(WriteBuffer writeBuffer) throws
      BufferException;
  ...
  public static BACnetTimeStamp staticParse(ReadBuffer readBuffer) throws BufferException {
    readBuffer.pushContext(WithOption.WithName("BACnetTimeStamp"));
  ...
  public void serialize(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("BACnetTimeStamp"));
    ...
    // Switch Field
    serializeBACnetTimeStampChild(writeBuffer);
