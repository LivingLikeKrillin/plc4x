...
public class BACnetFaultParameterFaultLifeSafety extends BACnetFaultParameter implements Message {
  ...
  public BACnetFaultParameterFaultLifeSafety(BACnetTagHeader peekedTagHeader,
  ...
  public static BACnetFaultParameterBuilder staticParseBACnetFaultParameterBuilder(
    ...
    readBuffer.pushContext(WithOption.WithName("BACnetFaultParameterFaultLifeSafety"));
  ...
  protected void serializeBACnetFaultParameterChild(WriteBuffer writeBuffer) throws
      BufferException {
    writeBuffer.pushContext(WithOption.WithName("BACnetFaultParameterFaultLifeSafety"));
    ...
    // Simple Field: listOfFaultValues
    FieldWriterFactory.writeSimpleField((BACnetFaultParameterFaultLifeSafetyListOfFaultValues) listOfFaultValues, DataWriterFactory.writeComplex(writeBuffer), WithOption.WithName("listOfFaultValues"));
  ...
  public static class BACnetFaultParameterBuilderImpl implements BACnetFaultParameter.BACnetFaultParameterBuilder {
    ...
    public BACnetFaultParameter build(BACnetTagHeader peekedTagHeader) {
      return new BACnetFaultParameterFaultLifeSafety(peekedTagHeader, openingTag, listOfFaultValues, modePropertyReference, closingTag);
    }
  }
}
