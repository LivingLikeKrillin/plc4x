...
public class BACnetChannelValueTime extends BACnetChannelValue implements Message {
  ...
  public BACnetChannelValueTime(BACnetTagHeader peekedTagHeader,
  ...
  public static BACnetChannelValueBuilder staticParseBACnetChannelValueBuilder(
    ...
    readBuffer.pushContext(WithOption.WithName("BACnetChannelValueTime"));
    ...
    return new BACnetChannelValueBuilderImpl(timeValue);
  }

  protected void serializeBACnetChannelValueChild(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("BACnetChannelValueTime"));
  ...
  public static class BACnetChannelValueBuilderImpl implements BACnetChannelValue.BACnetChannelValueBuilder {
    ...
    public BACnetChannelValueBuilderImpl(BACnetApplicationTagTime timeValue) {
      this.timeValue = timeValue;
    }

    public BACnetChannelValue build(BACnetTagHeader peekedTagHeader) {
      return new BACnetChannelValueTime(peekedTagHeader, timeValue);
    }
  }
}
