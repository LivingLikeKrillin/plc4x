...
public class BACnetWriteAccessSpecification implements Message {
  ...
  public BACnetWriteAccessSpecification(BACnetContextTagObjectIdentifier objectIdentifier,
  ...
  /**
   * Property field listOfPropertyWriteDefinition
   */
  ...
  public static BACnetWriteAccessSpecification staticParse(ReadBuffer readBuffer) throws
      BufferException {
    readBuffer.pushContext(WithOption.WithName("BACnetWriteAccessSpecification"));
    ...
    List<BACnetPropertyWriteDefinition> listOfPropertyWriteDefinition = FieldReaderFactory.readTerminatedArrayField(DataReaderFactory.readComplex(() -> (BACnetPropertyWriteDefinition) BACnetPropertyWriteDefinition.staticParse(readBuffer, (org.apache.plc4x.java.bacnetip.readwrite.BACnetObjectType) (objectIdentifier.getObjectType())), readBuffer), () -> (boolean) StaticHelper.isBACnetConstructedDataClosingTag(readBuffer, false, 1), WithOption.WithName("listOfPropertyWriteDefinition"));
    ...
    return new BACnetWriteAccessSpecification(objectIdentifier, openingTag, listOfPropertyWriteDefinition, closingTag);
  }

  @Override
  public void serialize(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("BACnetWriteAccessSpecification"));
    ...
    // Array Field: listOfPropertyWriteDefinition
    FieldWriterFactory.writeComplexTypeArrayField(listOfPropertyWriteDefinition, writeBuffer, WithOption.WithName("listOfPropertyWriteDefinition"));
  ...
  public int getLengthInBits() {
    ...
    // Array Field: listOfPropertyWriteDefinition
    for (Message _element : listOfPropertyWriteDefinition) {
