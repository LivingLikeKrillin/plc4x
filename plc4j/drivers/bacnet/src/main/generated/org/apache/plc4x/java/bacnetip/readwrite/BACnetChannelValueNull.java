...
public class BACnetChannelValueNull extends BACnetChannelValue implements Message {
  ...
  public BACnetChannelValueNull(BACnetTagHeader peekedTagHeader,
  ...
  public static BACnetChannelValueBuilder staticParseBACnetChannelValueBuilder(
    ...
    readBuffer.pushContext(WithOption.WithName("BACnetChannelValueNull"));
    ...
    return new BACnetChannelValueBuilderImpl(nullValue);
  }

  protected void serializeBACnetChannelValueChild(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("BACnetChannelValueNull"));
  ...
  public static class BACnetChannelValueBuilderImpl implements BACnetChannelValue.BACnetChannelValueBuilder {
    ...
    public BACnetChannelValueBuilderImpl(BACnetApplicationTagNull nullValue) {
      this.nullValue = nullValue;
    }

    public BACnetChannelValue build(BACnetTagHeader peekedTagHeader) {
      return new BACnetChannelValueNull(peekedTagHeader, nullValue);
    }
  }
}
