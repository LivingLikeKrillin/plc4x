 ...
 */
public class BACnetTimerStateChangeValueCharacterString extends BACnetTimerStateChangeValue implements Message {
  protected final BACnetApplicationTagCharacterString characterStringValue;

  public BACnetTimerStateChangeValueCharacterString(BACnetTagHeader peekedTagHeader,
  ...
  public static BACnetTimerStateChangeValueBuilder staticParseBACnetTimerStateChangeValueBuilder(
    ...
    readBuffer.pushContext(WithOption.WithName("BACnetTimerStateChangeValueCharacterString"));
  ...
  protected void serializeBACnetTimerStateChangeValueChild(WriteBuffer writeBuffer) throws
      BufferException {
    writeBuffer.pushContext(WithOption.WithName("BACnetTimerStateChangeValueCharacterString"));
  ...
  public static class BACnetTimerStateChangeValueBuilderImpl implements BACnetTimerStateChangeValue.BACnetTimerStateChangeValueBuilder {
    ...
    public BACnetTimerStateChangeValue build(BACnetTagHeader peekedTagHeader) {
      return new BACnetTimerStateChangeValueCharacterString(peekedTagHeader, characterStringValue);
    }
  }
}
