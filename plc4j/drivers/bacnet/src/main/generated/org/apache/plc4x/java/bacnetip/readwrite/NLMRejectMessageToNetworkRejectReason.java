...
public enum NLMRejectMessageToNetworkRejectReason {
  ...
  static {
    map = new HashMap<>();
    for (NLMRejectMessageToNetworkRejectReason value : NLMRejectMessageToNetworkRejectReason.values()) {
  ...
  public static NLMRejectMessageToNetworkRejectReason enumForValue(short value) {
