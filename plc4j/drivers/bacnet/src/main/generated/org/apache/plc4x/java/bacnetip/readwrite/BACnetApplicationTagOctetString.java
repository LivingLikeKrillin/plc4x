...
public class BACnetApplicationTagOctetString extends BACnetApplicationTag implements Message {
  ...
  public BACnetApplicationTagOctetString(BACnetTagHeader header,
  ...
  public static BACnetApplicationTagBuilder staticParseBACnetApplicationTagBuilder(
    ...
    readBuffer.pushContext(WithOption.WithName("BACnetApplicationTagOctetString"));
  ...
  protected void serializeBACnetApplicationTagChild(WriteBuffer writeBuffer) throws
      BufferException {
    writeBuffer.pushContext(WithOption.WithName("BACnetApplicationTagOctetString"));
    int startPos = writeBuffer.getPositionInBits();
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
    // Simple Field: payload
    FieldWriterFactory.writeSimpleField((BACnetTagPayloadOctetString) payload, DataWriterFactory.writeComplex(writeBuffer), WithOption.WithName("payload"));
  ...
  public static class BACnetApplicationTagBuilderImpl implements BACnetApplicationTag.BACnetApplicationTagBuilder {
    ...
    public BACnetApplicationTagBuilderImpl(BACnetTagPayloadOctetString payload) {
      this.payload = payload;
    }

    public BACnetApplicationTag build(BACnetTagHeader header) {
      return new BACnetApplicationTagOctetString(header, payload);
    }
  }
}
