 ...
 */
public abstract class BACnetSpecialEventPeriod implements Message {
  protected final BACnetTagHeader peekedTagHeader;

  public BACnetSpecialEventPeriod(BACnetTagHeader peekedTagHeader) {
    this.peekedTagHeader = peekedTagHeader;
  }

  protected abstract void serializeBACnetSpecialEventPeriodChild(WriteBuffer writeBuffer) throws
      BufferException;
  ...
  public static BACnetSpecialEventPeriod staticParse(ReadBuffer readBuffer) throws BufferException {
    readBuffer.pushContext(WithOption.WithName("BACnetSpecialEventPeriod"));
    ...
    if (EvaluationHelper.equals(peekedTagNumber, (short) (0))) {
      builder = BACnetSpecialEventPeriodCalendarEntry.staticParseBACnetSpecialEventPeriodBuilder(readBuffer);
    } else if (EvaluationHelper.equals(peekedTagNumber, (short) (1))) {
      builder = BACnetSpecialEventPeriodCalendarReference.staticParseBACnetSpecialEventPeriodBuilder(readBuffer);
    }
    if (builder == null) {
  ...
  public void serialize(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("BACnetSpecialEventPeriod"));
    ...
    // Switch Field
    serializeBACnetSpecialEventPeriodChild(writeBuffer);
