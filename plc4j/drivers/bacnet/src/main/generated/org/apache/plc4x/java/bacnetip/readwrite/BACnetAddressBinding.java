...
public class BACnetAddressBinding implements Message {
  ...
  public BACnetAddressBinding(BACnetApplicationTagObjectIdentifier deviceIdentifier,
  ...
  /**
   * Property field deviceAddress
   */
  public BACnetAddress getDeviceAddress() {
    return deviceAddress;
  }

  public static BACnetAddressBinding staticParse(ReadBuffer readBuffer) throws BufferException {
    readBuffer.pushContext(WithOption.WithName("BACnetAddressBinding"));
  ...
  public void serialize(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("BACnetAddressBinding"));
    ...
    // Simple Field: deviceAddress
    FieldWriterFactory.writeSimpleField((BACnetAddress) deviceAddress, DataWriterFactory.writeComplex(writeBuffer), WithOption.WithName("deviceAddress"));
