 ...
 */
public class BACnetLightingCommandEnclosed implements Message {
  ...
  public BACnetLightingCommandEnclosed(BACnetOpeningTag openingTag,
      BACnetLightingCommand lightingCommand, BACnetClosingTag closingTag) {
  ...
  public static BACnetLightingCommandEnclosed staticParse(ReadBuffer readBuffer, short tagNumber)
    ...
    readBuffer.pushContext(WithOption.WithName("BACnetLightingCommandEnclosed"));
  ...
  public void serialize(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("BACnetLightingCommandEnclosed"));
  ...
  public int getLengthInBits() {
    int lengthInBits = 0;
    BACnetLightingCommandEnclosed _value = this;
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
    // Simple Field: openingTag
