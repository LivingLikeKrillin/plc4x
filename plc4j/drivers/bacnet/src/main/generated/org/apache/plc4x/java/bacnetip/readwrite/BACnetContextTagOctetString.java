...
public class BACnetContextTagOctetString extends BACnetContextTag implements Message {
  ...
  public static BACnetContextTagBuilder staticParseBACnetContextTagBuilder(ReadBuffer readBuffer,
      ...
      BufferException {
    readBuffer.pushContext(WithOption.WithName("BACnetContextTagOctetString"));
  ...
  protected void serializeBACnetContextTagChild(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("BACnetContextTagOctetString"));
  ...
  public static class BACnetContextTagBuilderImpl implements BACnetContextTag.BACnetContextTagBuilder {
    ...
    public BACnetContextTagBuilderImpl(BACnetTagPayloadOctetString payload) {
      this.payload = payload;
    }

    public BACnetContextTag build(BACnetTagHeader header) {
      return new BACnetContextTagOctetString(header, payload);
    }
  }
}
