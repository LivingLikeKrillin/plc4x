 ...
 */
public abstract class BACnetFaultParameter implements Message {
  protected final BACnetTagHeader peekedTagHeader;

  public BACnetFaultParameter(BACnetTagHeader peekedTagHeader) {
    this.peekedTagHeader = peekedTagHeader;
  }

  protected abstract void serializeBACnetFaultParameterChild(WriteBuffer writeBuffer) throws
      BufferException;
  ...
  public static BACnetFaultParameter staticParse(ReadBuffer readBuffer) throws BufferException {
    readBuffer.pushContext(WithOption.WithName("BACnetFaultParameter"));
    ...
    if (EvaluationHelper.equals(peekedTagNumber, (short) (0))) {
      ...
      builder = BACnetFaultParameterFaultCharacterString.staticParseBACnetFaultParameterBuilder(readBuffer);
    } else if (EvaluationHelper.equals(peekedTagNumber, (short) (2))) {
      builder = BACnetFaultParameterFaultExtended.staticParseBACnetFaultParameterBuilder(readBuffer);
    } else if (EvaluationHelper.equals(peekedTagNumber, (short) (3))) {
      builder = BACnetFaultParameterFaultLifeSafety.staticParseBACnetFaultParameterBuilder(readBuffer);
      ...
      builder = BACnetFaultParameterFaultStatusFlags.staticParseBACnetFaultParameterBuilder(readBuffer);
    } else if (EvaluationHelper.equals(peekedTagNumber, (short) (6))) {
      builder = BACnetFaultParameterFaultOutOfRange.staticParseBACnetFaultParameterBuilder(readBuffer);
  ...
  public void serialize(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("BACnetFaultParameter"));
    ...
    // Switch Field
    serializeBACnetFaultParameterChild(writeBuffer);
