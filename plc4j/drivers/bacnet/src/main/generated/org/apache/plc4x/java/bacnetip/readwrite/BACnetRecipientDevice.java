...
public class BACnetRecipientDevice extends BACnetRecipient implements Message {
  ...
  public BACnetRecipientDevice(BACnetTagHeader peekedTagHeader,
  ...
  public static BACnetRecipientBuilder staticParseBACnetRecipientBuilder(ReadBuffer readBuffer)
    ...
    readBuffer.pushContext(WithOption.WithName("BACnetRecipientDevice"));
  ...
  protected void serializeBACnetRecipientChild(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("BACnetRecipientDevice"));
    int startPos = writeBuffer.getPositionInBits();
    boolean _lastItem = ThreadLocalHelper.lastItemThreadLocal.get();
    // Simple Field: deviceValue
    FieldWriterFactory.writeSimpleField((BACnetContextTagObjectIdentifier) deviceValue, DataWriterFactory.writeComplex(writeBuffer), WithOption.WithName("deviceValue"));
  ...
  public static class BACnetRecipientBuilderImpl implements BACnetRecipient.BACnetRecipientBuilder {
    private final BACnetContextTagObjectIdentifier deviceValue;

    public BACnetRecipientBuilderImpl(BACnetContextTagObjectIdentifier deviceValue) {
      this.deviceValue = deviceValue;
    }

    public BACnetRecipient build(BACnetTagHeader peekedTagHeader) {
      return new BACnetRecipientDevice(peekedTagHeader, deviceValue);
    }
  }
}
