...
public class BACnetNotifyTypeTagged implements Message {
  ...
  public static BACnetNotifyTypeTagged staticParse(ReadBuffer readBuffer, short tagNumber,
      TagClass tagClass) throws BufferException {
    readBuffer.pushContext(WithOption.WithName("BACnetNotifyTypeTagged"));
    ...
    // Manual Field: value
    BACnetNotifyType value = FieldReaderFactory.readManualField(readBuffer, () -> (BACnetNotifyType) (StaticHelper.readEnumGenericFailing(readBuffer, header.getActualLength(), BACnetNotifyType.ALARM)), WithOption.WithName("value"));

    readBuffer.popContext();
    return new BACnetNotifyTypeTagged(header, value);
  }

  @Override
  public void serialize(WriteBuffer writeBuffer) throws BufferException {
    writeBuffer.pushContext(WithOption.WithName("BACnetNotifyTypeTagged"));
