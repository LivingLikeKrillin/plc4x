...
func NewBACnetTimerStateChangeValueInteger(peekedTagHeader BACnetTagHeader, integerValue BACnetApplicationTagSignedInteger) *_BACnetTimerStateChangeValueInteger {
	if integerValue == nil {
