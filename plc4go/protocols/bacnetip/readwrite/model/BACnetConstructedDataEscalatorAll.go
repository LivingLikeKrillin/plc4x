...
func NewBACnetConstructedDataEscalatorAll(openingTag BACnetOpeningTag, peekedTagHeader BACnetTagHeader, closingTag BACnetClosingTag) *_BACnetConstructedDataEscalatorAll {
...
func (m *_BACnetConstructedDataEscalatorAll) GetPlx4xTypeName() string {
