...
func NewBACnetContextTagBitString(header BACnetTagHeader, payload BACnetTagPayloadBitString) *_BACnetContextTagBitString {
	if payload == nil {
...
func (m *_BACnetContextTagBitString) GetPlx4xTypeName() string {
