...
func NewBACnetConstructedDataAccessDoorPresentValue(openingTag BACnetOpeningTag, peekedTagHeader BACnetTagHeader, closingTag BACnetClosingTag, presentValue BACnetDoorValueTagged) *_BACnetConstructedDataAccessDoorPresentValue {
	if presentValue == nil {
...
func (m *_BACnetConstructedDataAccessDoorPresentValue) GetPlx4xTypeName() string {
