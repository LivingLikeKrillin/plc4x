...
func NewParameterValueInterfaceOptions1(value InterfaceOptions1, data []byte) *_ParameterValueInterfaceOptions1 {
	if value == nil {
...
func (m *_ParameterValueInterfaceOptions1) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ParameterValue, parameterType ParameterType, numBytes uint8) (__parameterValueInterfaceOptions1 ParameterValueInterfaceOptions1, err error) {
	...
	value, err := ReadSimpleField[InterfaceOptions1](ctx, "value", ReadComplex[InterfaceOptions1](InterfaceOptions1ParseWithBuffer, readBuffer), codegen.WithEncoding("UTF8"), codegen.WithByteOrder(binary.BigEndian))
	if err != nil {
...
func (m *_ParameterValueInterfaceOptions1) SerializeWithWriteBuffer(ctx context.Context, writeBuffer utils.WriteBuffer) error {
	...
	ser := func() error {
		...
		if err := WriteSimpleField[InterfaceOptions1](ctx, "value", m.GetValue(), WriteComplex[InterfaceOptions1](writeBuffer), codegen.WithEncoding("UTF8"), codegen.WithByteOrder(binary.BigEndian)); err != nil {
