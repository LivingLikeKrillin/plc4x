...
func (m *_TransferSubscriptionsResponse) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ExtensionObjectDefinition, extensionId int32) (__transferSubscriptionsResponse TransferSubscriptionsResponse, err error) {
	...
	results, err := ReadCountArrayField[TransferResult](ctx, "results", ReadComplex[TransferResult](ExtensionObjectDefinitionParseWithBufferProducer[TransferResult]((int32)(int32(838))), readBuffer), uint64(noOfResults), codegen.WithEncoding("UTF8"))
	if err != nil {
