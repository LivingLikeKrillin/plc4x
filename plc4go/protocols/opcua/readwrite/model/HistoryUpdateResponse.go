...
func (m *_HistoryUpdateResponse) GetPlx4xTypeName() string {
...
func (m *_HistoryUpdateResponse) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ExtensionObjectDefinition, extensionId int32) (__historyUpdateResponse HistoryUpdateResponse, err error) {
	...
	results, err := ReadCountArrayField[HistoryUpdateResult](ctx, "results", ReadComplex[HistoryUpdateResult](ExtensionObjectDefinitionParseWithBufferProducer[HistoryUpdateResult]((int32)(int32(697))), readBuffer), uint64(noOfResults), codegen.WithEncoding("UTF8"))
	if err != nil {
