...
func (m *_HistoryReadResponse) GetPlx4xTypeName() string {
...
func (m *_HistoryReadResponse) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ExtensionObjectDefinition, extensionId int32) (__historyReadResponse HistoryReadResponse, err error) {
	...
	results, err := ReadCountArrayField[HistoryReadResult](ctx, "results", ReadComplex[HistoryReadResult](ExtensionObjectDefinitionParseWithBufferProducer[HistoryReadResult]((int32)(int32(640))), readBuffer), uint64(noOfResults), codegen.WithEncoding("UTF8"))
	if err != nil {
