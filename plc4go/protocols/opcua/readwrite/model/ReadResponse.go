...
func (m *_ReadResponse) GetPlx4xTypeName() string {
	return "ReadResponse"
}
...
func (m *_ReadResponse) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ExtensionObjectDefinition, extensionId int32) (__readResponse ReadResponse, err error) {
	...
	results, err := ReadCountArrayField[DataValue](ctx, "results", ReadComplex[DataValue](DataValueParseWithBuffer, readBuffer), uint64(noOfResults), codegen.WithEncoding("UTF8"))
	if err != nil {
