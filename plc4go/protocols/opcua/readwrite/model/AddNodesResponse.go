...
func (m *_AddNodesResponse) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ExtensionObjectDefinition, extensionId int32) (__addNodesResponse AddNodesResponse, err error) {
	...
	results, err := ReadCountArrayField[AddNodesResult](ctx, "results", ReadComplex[AddNodesResult](ExtensionObjectDefinitionParseWithBufferProducer[AddNodesResult]((int32)(int32(485))), readBuffer), uint64(noOfResults), codegen.WithEncoding("UTF8"))
	if err != nil {
