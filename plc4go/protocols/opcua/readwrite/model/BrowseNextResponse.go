...
func (m *_BrowseNextResponse) GetPlx4xTypeName() string {
...
func (m *_BrowseNextResponse) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ExtensionObjectDefinition, extensionId int32) (__browseNextResponse BrowseNextResponse, err error) {
	...
	results, err := ReadCountArrayField[BrowseResult](ctx, "results", ReadComplex[BrowseResult](ExtensionObjectDefinitionParseWithBufferProducer[BrowseResult]((int32)(int32(524))), readBuffer), uint64(noOfResults), codegen.WithEncoding("UTF8"))
	if err != nil {
