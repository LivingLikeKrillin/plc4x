...
func (m *_CallResponse) parse(ctx context.Context, readBuffer utils.ReadBuffer, parent *_ExtensionObjectDefinition, extensionId int32) (__callResponse CallResponse, err error) {
	...
	results, err := ReadCountArrayField[CallMethodResult](ctx, "results", ReadComplex[CallMethodResult](ExtensionObjectDefinitionParseWithBufferProducer[CallMethodResult]((int32)(int32(709))), readBuffer), uint64(noOfResults), codegen.WithEncoding("UTF8"))
	if err != nil {
